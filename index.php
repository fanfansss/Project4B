	...
	<head>
		...
		<body>
			  ...
			  <header id="header" id="home">
			    ...
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.html"><img src="img/logo1.jpeg" alt="" title="ccc" /></a>
				      </div>
			...
			<section class="banner-area5" id="home">	
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content5 col-lg-7">
							<br>
							<br>
							<!-- <h6 class="text-white text-uppercase">Alat Kopi</h6> -->
							<h1>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						...
						<div class="col-lg-5  col-md-6 col-sm-6">
							<div class="single-footer-widget">
								<h6>Jl. Veteran Terdalam Malang</h6>
